...
var productList = null; //"null" means it's available but completely empty
var submitButton = null;
var errorElement = null;
var totalPriceField = null;
var removeText = "X";
var errorText = "Oeps, check je invoer nogmaals...";
...
function init(e) {
    ...
    productList.addEventListener("click", removeProduct, false);
...
function addProduct(e) {
    ...
    var tableRow = createNewElement("tr", false, false);
    var productCell = createNewElement("td", productField.value, false);
    var priceCell = createNewElement("td", priceField.value, false);

    //Create a remove 'button' with a specific class to handle removing later on
    var removeCell = createNewElement("td", removeText, "remove-cell");
